        ...
        if (hasError != true) {
            ...
            RegisterApi(inputs).then((response) => {
                ...
                if (err.response.data.error.message == "EMAIL_EXISTS") {
                    setErrors({ ...errors, custom_error: "Already has registerd ! :(" })
                }
                else if (String(err.response.data.error.message).includes("WEAK_PASSWORD")) {
                    setErrors({ ...errors, custom_error: "Password Must Be In Morethan 6 Letters :)" })
                        ...
                        <div className="col register-sec">
                            ...
                            <form onSubmit={handleSubmit} className="register-form" action="" >
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="submit" className="btn btn-login float-right" value="Register" disabled={lodding} />
                                </div>
